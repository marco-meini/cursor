...
12. **Run tests:** After writing tests, **run** them (e.g. `npm test -- ${testFile}`) and iterate until **all tests pass**. Fix failures by changing **test code only**, not production.
